...
//      Compile / scalaSource := baseDirectory.value / "hw" / "spinal",
//  )
//scalacOptions += "-P:semanticdb:sourceroot:/media/other_data/fl4shk_home_stuff/Documents/prog/electronics/spinalhdl/small_projects_and_tests/libsnowhouse"
//scalacOptions += "-Ybackend-parallelism 4"

lazy val mister_fpga_sdram_test = (project in file("."))
...
//libsnowhouse.dependsOn(libcheesevoyage % "compile->libcheesevoyage")
//libsnowhouse.dependsOn(libcheesevoyage)
